...
{
    public static function althoughExpectedForIdentifier(TaskIdentifier $identifier): TaskDoesNotExist
    {
        return new static('No task with identifier ' . $identifier . ' exists.', 1567600174);
    }
}
