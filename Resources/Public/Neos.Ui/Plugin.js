...
/***/ "./node_modules/@neos-project/brand/index.js":
/*!***************************************************!*\
  !*** ./node_modules/@neos-project/brand/index.js ***!
  \***************************************************/
...
var upperFirst = __webpack_require__(/*! lodash.upperfirst */ "./node_modules/lodash.upperfirst/index.js");
...
var generateCssVarsObject = function generateCssVarsObject() {
	var subject = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : config;
	var predicate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';

	var hasPredicate = predicate && predicate.length;
	var target = {};

	Object.keys(subject).forEach(function (key) {
		var val = subject[key];
		var camelKey = upperFirst(key);
		var nestedPredicate = hasPredicate ? predicate + camelKey : key;
...
module.exports = {
	config: config,
	generateCssVarsObject: generateCssVarsObject
};

/***/ }),

/***/ "./node_modules/@neos-project/build-essentials/src/styles/styleConstants.js":
/*!**********************************************************************************!*\
  !*** ./node_modules/@neos-project/build-essentials/src/styles/styleConstants.js ***!
  \**********************************************************************************/
/*! no static exports found */
...
var _styleConstants = __webpack_require__(/*! @neos-project/build-essentials/src/styles/styleConstants */ "./node_modules/@neos-project/build-essentials/src/styles/styleConstants.js");
...
var IntervalEditor = exports.IntervalEditor = function (_React$Component) {
    _inherits(IntervalEditor, _React$Component);

    function IntervalEditor() {
        _classCallCheck(this, IntervalEditor);

        return _possibleConstructorReturn(this, (IntervalEditor.__proto__ || Object.getPrototypeOf(IntervalEditor)).apply(this, arguments));
    }

    _createClass(IntervalEditor, [{
        key: "render",
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { style: { display: 'flex', marginBottom: _styleConstants.config.spacing.full } },
                    _react2.default.createElement(
                        _reactUiComponents.Button,
                        {
                            onClick: function onClick() {
                                var amountAsNumber = parseInt(amount, 10);

                                if (amountAsNumber > 1) {
                                    _this2.props.commit("" + dateOrTime + (amountAsNumber - 1) + unit);
                                }
                            }
                        },
                        "-"
                    ...
                    _react2.default.createElement(_reactUiComponents.TextInput, {
                        ...
                        onChange: function onChange(amount) {
                            if (/^\d+$/.test(amount)) {
                                _this2.props.commit("" + dateOrTime + amount + unit);
                            }
                        }
                    }),
                    _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactUiComponents.SelectBox, {
                        ...
                        onValueChange: function onValueChange(_ref) {
                            var dateOrTime = _ref.dateOrTime,
                                unit = _ref.unit;
                            return _this2.props.commit("" + dateOrTime + amount + unit);
                        },
                        value: { dateOrTime: dateOrTime, unit: unit },
                        options: [{
                            label: i18n.translate(amount === '1' ? 'Sitegeist.Bitzer:NeosUiPlugin:intervalEditor.unit.minute' : 'Sitegeist.Bitzer:NeosUiPlugin:intervalEditor.unit.minutes'),
                            value: { dateOrTime: 'PT', unit: 'M' }
                        }, {
                            label: i18n.translate(amount === '1' ? 'Sitegeist.Bitzer:NeosUiPlugin:intervalEditor.unit.hour' : 'Sitegeist.Bitzer:NeosUiPlugin:intervalEditor.unit.hours'),
                            value: { dateOrTime: 'PT', unit: 'H' }
                        }, {
                            label: i18n.translate(amount === '1' ? 'Sitegeist.Bitzer:NeosUiPlugin:intervalEditor.unit.day' : 'Sitegeist.Bitzer:NeosUiPlugin:intervalEditor.unit.days'),
                            value: { dateOrTime: 'P', unit: 'D' }
                        }, {
                            label: i18n.translate(amount === '1' ? 'Sitegeist.Bitzer:NeosUiPlugin:intervalEditor.unit.week' : 'Sitegeist.Bitzer:NeosUiPlugin:intervalEditor.unit.weeks'),
                            value: { dateOrTime: 'P', unit: 'W' }
                        }, {
                            label: i18n.translate(amount === '1' ? 'Sitegeist.Bitzer:NeosUiPlugin:intervalEditor.unit.month' : 'Sitegeist.Bitzer:NeosUiPlugin:intervalEditor.unit.months'),
                            value: { dateOrTime: 'P', unit: 'M' }
                        }, {
                            label: i18n.translate(amount === '1' ? 'Sitegeist.Bitzer:NeosUiPlugin:intervalEditor.unit.year' : 'Sitegeist.Bitzer:NeosUiPlugin:intervalEditor.unit.years'),
...
var _brand = __webpack_require__(/*! @neos-project/brand */ "./node_modules/@neos-project/brand/index.js");
...
function Metric(props) {
    ...
    return _react2.default.createElement(
        ...
        {
            style: {
                fontSize: _styleConstants.config.fontSize.base,
                color: 'white',
                padding: "0 " + _styleConstants.config.spacing.half,
                lineHeight: _styleConstants.config.spacing.goldenUnit,
                backgroundColor: (0, _classnames2.default)((_mergeClassNames = {}, _defineProperty(_mergeClassNames, _brand.config.colors.primaryBlue, props.info), _defineProperty(_mergeClassNames, _brand.config.colors.warn, props.warn), _defineProperty(_mergeClassNames, _brand.config.colors.error, props.danger), _mergeClassNames))
            }
        },
        props.children
    );
...
var Reminder = exports.Reminder = function (_React$Component) {
    ...
    function Reminder() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Reminder.__proto__ || Object.getPrototypeOf(Reminder)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            data: null,
            storage: JSON.parse(localStorage.getItem(_constants.NAMESPACE) || '{}')
        }, _this.handleGoToBitzer = function () {
    ...
    _createClass(Reminder, [{
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                if (!(!storage.latestUpdate || storage.latestUpdate !== _constants.TODAY)) {
                                    _context.next = 9;
                                    break;
                                }
        ...
        value: function render() {
            ...
            if (getAnyTasksAreDueOrUpcoming(data)) {
                localStorage.setItem(_constants.NAMESPACE, JSON.stringify(_extends({}, storage, {
                    latestUpdate: _constants.TODAY
                })));
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { style: { padding: _styleConstants.config.spacing.full } },
                        _react2.default.createElement(
                            "p",
                            { style: { marginTop: 0, marginBottom: _styleConstants.config.spacing.full } },
                            i18n.translate('Sitegeist.Bitzer:NeosUiPlugin:reminder.introduction')
                        ),
                        _react2.default.createElement(
                            "ul",
                            { style: { marginBottom: _styleConstants.config.spacing.full } },
                            data.numberOfTasksPastDue ? _react2.default.createElement(
                                "li",
                                { style: { marginBottom: _styleConstants.config.spacing.half } },
                                _react2.default.createElement(
                                    Metric,
                                    { danger: true },
                                    i18n.translate(data.numberOfTasksPastDue === 1 ? 'Sitegeist.Bitzer:NeosUiPlugin:reminder.taskPastDue' : 'Sitegeist.Bitzer:NeosUiPlugin:reminder.tasksPastDue', '', { 0: data.numberOfTasksPastDue })
                                )
                            ) : null,
                            data.numberOfTasksDue ? _react2.default.createElement(
                                "li",
                                { style: { marginBottom: _styleConstants.config.spacing.half } },
                                _react2.default.createElement(
                                    Metric,
                                    { warn: true },
                                    i18n.translate(data.numberOfTasksDue === 1 ? 'Sitegeist.Bitzer:NeosUiPlugin:reminder.taskDue' : 'Sitegeist.Bitzer:NeosUiPlugin:reminder.tasksDue', '', { 0: data.numberOfTasksDue })
                                )
                            ) : null,
                            data.numberOfUpcomingTasks ? _react2.default.createElement(
                                "li",
                                { style: { marginBottom: _styleConstants.config.spacing.half } },
                                _react2.default.createElement(
                                    Metric,
                                    { info: true },
                                    i18n.translate(data.numberOfUpcomingTasks === 1 ? 'Sitegeist.Bitzer:NeosUiPlugin:reminder.taskUpcoming' : 'Sitegeist.Bitzer:NeosUiPlugin:reminder.tasksUpcoming', '', { 0: data.numberOfUpcomingTasks })
                                )
                            ) : null
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _reactUiComponents.Button,
                                { onClick: function onClick() {
                                        return _this2.setState({ data: null });
                                    } },
                                i18n.translate('Sitegeist.Bitzer:NeosUiPlugin:reminder.action.dismiss')
                            ),
                            _react2.default.createElement(
                                _reactUiComponents.Button,
                                { style: "warn", onClick: this.handleGoToBitzer },
...
exports.PATTERN_INTERVAL = exports.TODAY = exports.NAMESPACE = undefined;

var _format = __webpack_require__(/*! date-fns/format */ "./node_modules/date-fns/esm/format/index.js");

var _format2 = _interopRequireDefault(_format);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var NAMESPACE = exports.NAMESPACE = 'Sitegeist.Bitzer:Plugin';
var TODAY = exports.TODAY = (0, _format2.default)(new Date(), 'yyyy-MM-dd');
var PATTERN_INTERVAL = exports.PATTERN_INTERVAL = /^(P|PT)(\d+)([A-Z])$/;
...
var _Reminder = __webpack_require__(/*! ./Reminder */ "./src/Reminder.js");

var _IntervalEditor = __webpack_require__(/*! ./IntervalEditor */ "./src/IntervalEditor.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)(_constants.NAMESPACE, {}, function (globalRegistry) {
    var containersRegistry = globalRegistry.get('containers');
    var editorsRegistry = globalRegistry.get('inspector').get('editors');

    containersRegistry.set('Modals/Sitegeist.Bitzer.Reminder', function (props) {
        return _react2.default.createElement(_Reminder.Reminder, _extends({}, props, { i18n: globalRegistry.get('i18n') }));
    });

    editorsRegistry.set('Sitegeist.Bitzer/Inspector/Editors/IntervalEditor', {
        component: function component(props) {
            return _react2.default.createElement(_IntervalEditor.IntervalEditor, _extends({}, props, { i18n: globalRegistry.get('i18n') }));
        }
    });
});
